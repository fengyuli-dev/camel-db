...
val parse_insert : database -> token list -> unit
...
val parse_delete : database -> token list -> unit
...
val parse_update : database -> token list -> unit
