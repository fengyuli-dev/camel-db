...
(* [get_field_name_list database table] returns list of column names.*)
val get_field_name_list : database -> string -> string list
(* [get_column_data database table column] returns list of data in this column as string list. *)
